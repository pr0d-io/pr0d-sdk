...
var ICONS = {
  add: async () => (await import("./add-ZCIHL3U5.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-YKGLY46U.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-QU7JWNH2.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-AYR2MWMO.js")).appStoreSvg,
  apple: async () => (await import("./apple-4RQR5RGI.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-QFXCYQVB.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-GYYZ7UY5.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-EP6MZQTK.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-B7W6JI3W.js")).arrowTopSvg,
  bank: async () => (await import("./bank-HVEY2BCY.js")).bankSvg,
  browser: async () => (await import("./browser-TSH3BTHB.js")).browserSvg,
  card: async () => (await import("./card-AEFIGN6A.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-EUTNFR7X.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-5WDQBJJL.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-ZIV3Y5E7.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-FHRFEVFL.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-YSKUJWFS.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-HL54VZ6A.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-CHV4D4JK.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-DU4CXPLR.js")).clockSvg,
  close: async () => (await import("./close-EZ73CMLW.js")).closeSvg,
  compass: async () => (await import("./compass-LDFRLYCI.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-SZ5AOKCF.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-VOPKPJWK.js")).copySvg,
  cursor: async () => (await import("./cursor-IN3XQ5OC.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-7H5NYY2F.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-SGHZ5HWJ.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-WL76BIPO.js")).disconnectSvg,
  discord: async () => (await import("./discord-4UHGYJR2.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-USDHDYFA.js")).etherscanSvg,
  extension: async () => (await import("./extension-6MUXNRUP.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-FOJXWIN3.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-2LQKNWO2.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-ROVYYPVT.js")).farcasterSvg,
  filters: async () => (await import("./filters-RXMDK3PY.js")).filtersSvg,
  github: async () => (await import("./github-KMYNMLXU.js")).githubSvg,
  google: async () => (await import("./google-Q4U552A6.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-36J62ZB7.js")).helpCircleSvg,
  image: async () => (await import("./image-JGETDMUE.js")).imageSvg,
  id: async () => (await import("./id-5X6OXETY.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-WRDJMRPL.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-EAPPLRLB.js")).lightbulbSvg,
  mail: async () => (await import("./mail-IIKXJ5GP.js")).mailSvg,
  mobile: async () => (await import("./mobile-EQPXULP5.js")).mobileSvg,
  more: async () => (await import("./more-7AB5N4D4.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-F7VBOVPB.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-RJXA2WRJ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-6EMSUBBN.js")).offSvg,
  playStore: async () => (await import("./play-store-B23MQC5N.js")).playStoreSvg,
  plus: async () => (await import("./plus-7OXZ2FMG.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-VHS5UVLU.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-3QVA3ND3.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-7CS36SB5.js")).refreshSvg,
  search: async () => (await import("./search-IKJVQCNB.js")).searchSvg,
  send: async () => (await import("./send-WK6VVUZC.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-5L4KFGJB.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-4FDYYS3X.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-365Y3LZ7.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-5OATM2HM.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-LJMEYUPI.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-VNKDDX65.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-FC4YGHGA.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-X7ULOQBO.js")).twitchSvg,
  twitter: async () => (await import("./x-TTLS6FNA.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-IA53QO4H.js")).twitterIconSvg,
  verify: async () => (await import("./verify-OSBZBC6D.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-YUFOE42V.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-5WZOEGN3.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-7LCBWOJE.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-7LCBWOJE.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-7LCBWOJE.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-V3DPDKUV.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-B7UOPZP6.js")).warningCircleSvg,
  x: async () => (await import("./x-TTLS6FNA.js")).xSvg,
  info: async () => (await import("./info-GIBFPI33.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-O3CBYWVC.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-RJSBH7BD.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VTKXSGWN.js.map
