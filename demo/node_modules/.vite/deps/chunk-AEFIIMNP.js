...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-SXAODKZ5.js").then((module) => module.WebSocket);
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-5XCTAQVS.js");
  const signature_ = (() => {
...
//# sourceMappingURL=chunk-AEFIIMNP.js.map
