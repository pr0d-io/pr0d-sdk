import { i as N, e as G, r as q, a as O, x as c, C as M, A as z, O as ee, b as k, E as te, R as U, c as Me, d as K, f as j, S as ft, g as Cn, W as pt, h as Zt, j as vi, T as ei, k as Xe, M as on, l as rn, m as Ne, n as yi, o as $n } from "./core-CAUl_m0s.mjs";
import { n as u, c as B, o as I, r as _, U as he, e as Rn, f as _n, a as En } from "./index-DAGxmpz4.mjs";
import { g as In } from "./index-D2fjni-0.mjs";
const Wn = N`
  :host {
    position: relative;
...
let Ze = class extends O {
  ...
  render() {
    ...
    return c`${this.walletImages.slice(0, Et).map(({ src: i, walletName: n }) => c`
            <wui-wallet-image
              size="inherit"
              imageSrc=${i}
              name=${I(n)}
...
let ye = class extends O {
  ...
  render() {
    const e = this.connectors.find((l) => l.id === "walletConnect"), { allWallets: i } = ee.state;
    if (!e || i === "HIDE" || i === "ONLY_MOBILE" && !k.isMobile())
      return null;
    const n = z.state.featured.length, o = this.count + n, t = o < 10 ? o : Math.floor(o / 10) * 10, a = this.filteredCount > 0 ? this.filteredCount : t;
    let s = `${a}`;
...
let et = class extends O {
  ...
  onConnector(e) {
    e.id === "walletConnect" ? k.isMobile() ? U.push("AllWallets") : U.push("ConnectingWalletConnect") : U.push("ConnectingExternal", { connector: e });
  }
};
ai([
  u()
...
let Ue = class extends O {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = M.state.connectors, this.loading = !1, this.unsubscribe.push(M.subscribeKey("connectors", (e) => this.connectors = e)), k.isTelegram() && k.isIos() && (this.loading = !j.state.wcUri, this.unsubscribe.push(j.subscribeKey("wcUri", (e) => this.loading = !e)));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  filterOutDuplicateWallets(e) {
    const i = ft.getRecentWallets(), n = this.connectors.map((s) => {
      var l;
      return (l = s.info) == null ? void 0 : l.rdns;
    }).filter(Boolean), o = i.map((s) => s.rdns).filter(Boolean), t = n.concat(o);
    if (t.includes("io.metamask.mobile") && k.isMobile()) {
...
Ue = gt([
  B("w3m-connect-custom-widget")
], Ue);
var si = function(r, e, i, n) {
  var o = arguments.length, t = o < 3 ? e : n === null ? n = Object.getOwnPropertyDescriptor(e, i) : n, a;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(r, e, i, n);
  else for (var s = r.length - 1; s >= 0; s--) (a = r[s]) && (t = (o < 3 ? a(t) : o > 3 ? a(e, i, t) : a(e, i)) || t);
  return o > 3 && t && Object.defineProperty(e, i, t), t;
...
let tt = class extends O {
  ...
  render() {
    const n = this.connectors.filter((o) => o.type === "EXTERNAL").filter(Me.showConnector).filter((o) => o.id !== Cn.CONNECTOR_ID.COINBASE_SDK);
    return n != null && n.length ? c`
      <wui-flex flexDirection="column" gap="xs">
        ${n.map((o) => c`
            <wui-list-wallet
...
tt = si([
  B("w3m-connect-external-widget")
], tt);
var li = function(r, e, i, n) {
  var o = arguments.length, t = o < 3 ? e : n === null ? n = Object.getOwnPropertyDescriptor(e, i) : n, a;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(r, e, i, n);
  else for (var s = r.length - 1; s >= 0; s--) (a = r[s]) && (t = (o < 3 ? a(t) : o > 3 ? a(e, i, t) : a(e, i)) || t);
  return o > 3 && t && Object.defineProperty(e, i, t), t;
...
li([
  u()
], it.prototype, "wallets", void 0);
it = li([
  B("w3m-connect-featured-widget")
], it);
...
let qe = class extends O {
  ...
  render() {
    const i = ft.getRecentWallets().filter((n) => !pt.isExcluded(n)).filter((n) => !this.hasWalletConnector(n)).filter((n) => this.isWalletCompatibleWithCurrentChain(n));
    return i.length ? c`
      <wui-flex flexDirection="column" gap="xs">
        ${i.map((n) => c`
            <wui-list-wallet
...
let Fe = class extends O {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.wallets = [], this.loading = !1, k.isTelegram() && k.isIos() && (this.loading = !j.state.wcUri, this.unsubscribe.push(j.subscribeKey("wcUri", (e) => this.loading = !e)));
  }
  render() {
    const { connectors: e } = M.state, { customWallets: i, featuredWalletIds: n } = ee.state, o = ft.getRecentWallets(), t = e.find((p) => p.id === "walletConnect"), s = e.filter((p) => p.type === "INJECTED" || p.type === "ANNOUNCED" || p.type === "MULTI_CHAIN").filter((p) => p.name !== "Browser Wallet");
    if (!t)
      return null;
  ...
  onConnectWallet(e) {
    ...
    i ? U.push("ConnectingExternal", { connector: i }) : U.push("ConnectingWalletConnect", { wallet: e });
  }
};
bt([
  u()
...
Fe = bt([
  B("w3m-connect-recommended-widget")
], Fe);
...
let Ve = class extends O {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = M.state.connectors, this.connectorImages = vi.state.connectorImages, this.unsubscribe.push(M.subscribeKey("connectors", (e) => this.connectors = e), vi.subscribeKey("connectorImages", (e) => this.connectorImages = e));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
...
Ve = mt([
  B("w3m-connect-walletconnect-widget")
], Ve);
const Pn = N`
  :host {
...
let xe = class extends O {
  ...
  connectorListTemplate() {
    const { custom: e, recent: i, announced: n, injected: o, multiChain: t, recommended: a, featured: s, external: l } = Me.getConnectorsByType(this.connectors, this.recommended, this.featured);
...
let Q = class extends O {
  ...
  loadingTemplate() {
    if (this.loading) {
      const e = An[this.size], i = this.disabled ? xi.disabled : xi[this.variant];
      return c`<wui-loading-spinner color=${i} size=${e}></wui-loading-spinner>`;
    }
    return c``;
  }
};
...
let st = class extends O {
  ...
  render() {
    ...
    const { name: e, app_store: i, play_store: n, chrome_store: o, homepage: t } = this.wallet, a = k.isMobile(), s = k.isIos(), l = k.isAndroid(), d = [i, n, t, o].filter(Boolean).length > 1, h = he.getTruncateString({
      string: e,
      charsStart: 12,
      charsEnd: 0,
      truncate: "end"
  ...
  onAppStore() {
    var e;
    (e = this.wallet) != null && e.app_store && k.openHref(this.wallet.app_store, "_blank");
  }
  onPlayStore() {
    var e;
    (e = this.wallet) != null && e.play_store && k.openHref(this.wallet.play_store, "_blank");
  }
  onHomePage() {
    var e;
    (e = this.wallet) != null && e.homepage && k.openHref(this.wallet.homepage, "_blank");
  }
};
st.styles = [Nn];
ln([
...
class V extends O {
  constructor() {
    var e, i, n, o, t;
    super(), this.wallet = (e = U.state.data) == null ? void 0 : e.wallet, this.connector = (i = U.state.data) == null ? void 0 : i.connector, this.timeout = void 0, this.secondaryBtnIcon = "refresh", this.onConnect = void 0, this.onRender = void 0, this.onAutoConnect = void 0, this.isWalletConnect = !0, this.unsubscribe = [], this.imageSrc = K.getWalletImage(this.wallet) ?? K.getConnectorImage(this.connector), this.name = ((n = this.wallet) == null ? void 0 : n.name) ?? ((o = this.connector) == null ? void 0 : o.name) ?? "Wallet", this.isRetrying = !1, this.uri = j.state.wcUri, this.error = j.state.wcError, this.ready = !1, this.showRetry = !1, this.secondaryBtnLabel = "Try again", this.secondaryLabel = "Accept connection request in the wallet", this.isLoading = !1, this.isMobile = !1, this.onRetry = void 0, this.unsubscribe.push(j.subscribeKey("wcUri", (a) => {
      var s;
      this.uri = a, this.isRetrying && this.onRetry && (this.isRetrying = !1, (s = this.onConnect) == null || s.call(this));
    }), j.subscribeKey("wcError", (a) => this.error = a)), (k.isTelegram() || k.isSafari()) && k.isIos() && j.state.wcUri && ((t = this.onConnect) == null || t.call(this));
  }
  firstUpdated() {
    var e;
  ...
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e()), j.setWcError(!1), clearTimeout(this.timeout);
  }
  render() {
    var n;
    ...
    return this.error && (i = "Connection declined"), c`
      <wui-flex
  ...
  onTryAgain() {
    var e, i;
    j.setWcError(!1), this.onRetry ? (this.isRetrying = !0, (e = this.onRetry) == null || e.call(this)) : (i = this.onConnect) == null || i.call(this);
  }
  loaderTemplate() {
    const e = ei.state.themeVariables["--w3m-border-radius-master"], i = e ? parseInt(e.replace("px", ""), 10) : 4;
    return c`<wui-loading-thumbnail radius=${i * 9}></wui-loading-thumbnail>`;
  }
  onCopyUri() {
    try {
      this.uri && (k.copyToClopboard(this.uri), Xe.showSuccess("Link copied"));
    } catch {
...
let Ci = class extends V {
  ...
  async onConnectProxy() {
    ...
    try {
      this.error = !1;
      const { connectors: i } = M.state, n = i.find((o) => {
        var t, a, s;
...
Ci = Un([
  B("w3m-connecting-wc-browser")
], Ci);
var qn = function(r, e, i, n) {
  var o = arguments.length, t = o < 3 ? e : n === null ? n = Object.getOwnPropertyDescriptor(e, i) : n, a;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(r, e, i, n);
  else for (var s = r.length - 1; s >= 0; s--) (a = r[s]) && (t = (o < 3 ? a(t) : o > 3 ? a(e, i, t) : a(e, i)) || t);
  return o > 3 && t && Object.defineProperty(e, i, t), t;
...
let $i = class extends V {
  ...
  onConnectProxy() {
    ...
    if ((e = this.wallet) != null && e.desktop_link && this.uri)
      try {
        this.error = !1;
        const { desktop_link: i, name: n } = this.wallet, { redirect: o, href: t } = k.formatNativeUrl(i, this.uri);
        j.setWcLinking({ name: n, href: t }), j.setRecentWallet(this.wallet), k.openHref(o, "_blank");
      } catch {
        this.error = !0;
      }
  }
...
let Ce = class extends V {
  constructor() {
    if (super(), this.btnLabelTimeout = void 0, this.redirectDeeplink = void 0, this.redirectUniversalLink = void 0, this.target = void 0, this.preferUniversalLinks = ee.state.experimental_preferUniversalLinks, this.isLoading = !0, this.onConnect = () => {
      ...
      if ((e = this.wallet) != null && e.mobile_link && this.uri)
        try {
          this.error = !1;
          const { mobile_link: i, link_mode: n, name: o } = this.wallet, { redirect: t, redirectUniversalLink: a, href: s } = k.formatNativeUrl(i, this.uri, n);
          this.redirectDeeplink = t, this.redirectUniversalLink = a, this.target = k.isIframe() ? "_top" : "_self", j.setWcLinking({ name: o, href: s }), j.setRecentWallet(this.wallet), this.preferUniversalLinks && this.redirectUniversalLink ? k.openHref(this.redirectUniversalLink, this.target) : k.openHref(this.redirectDeeplink, this.target);
        } catch (i) {
          te.sendEvent({
            type: "track",
    ...
    this.secondaryBtnLabel = "Open", this.secondaryLabel = rn.CONNECT_LABELS.MOBILE, this.secondaryBtnIcon = "externalLink", this.onHandleURI(), this.unsubscribe.push(j.subscribeKey("wcUri", () => {
      this.onHandleURI();
    })), te.sendEvent({
      type: "track",
      event: "SELECT_WALLET",
  ...
  onTryAgain() {
    var e;
    j.setWcError(!1), (e = this.onConnect) == null || e.call(this);
  }
};
ke([
  _()
...
Ce = ke([
  B("w3m-connecting-wc-mobile")
], Ce);
var Te = {}, It, Ri;
function Fn() {
  return Ri || (Ri = 1, It = function() {
...
function Ie() {
  ...
  return be.getSymbolSize = function(n) {
    ...
    return n * 4 + 17;
  }, be.getSymbolTotalCodewords = function(n) {
    return e[n];
  }, be.getBCHDigit = function(i) {
    let n = 0;
    for (; i !== 0; )
      n++, i >>>= 1;
    return n;
  }, be.setToSJISFunction = function(n) {
    if (typeof n != "function")
      throw new Error('"toSJISFunc" is not a valid function.');
    r = n;
  }, be.isKanjiModeEnabled = function() {
    return typeof r < "u";
  }, be.toSJIS = function(n) {
    return r(n);
  }, be;
}
var St = {}, Ei;
...
function Vn() {
  ...
  return r.prototype = {
    ...
    putBit: function(e) {
      ...
      this.buffer.length <= i && this.buffer.push(0), e && (this.buffer[i] |= 128 >>> this.length % 8), this.length++;
    }
  }, Tt = r, Tt;
}
var Pt, Wi;
function Kn() {
  ...
  return r.prototype.set = function(e, i, n, o) {
    const t = e * this.size + i;
    this.data[t] = n, o && (this.reservedBit[t] = !0);
  }, r.prototype.get = function(e, i) {
    return this.data[e * this.size + i];
  }, r.prototype.xor = function(e, i, n) {
    this.data[e * this.size + i] ^= n;
  }, r.prototype.isReserved = function(e, i) {
    return this.reservedBit[e * this.size + i];
  }, Pt = r, Pt;
}
var Bt = {}, Si;
function Hn() {
...
function Gn() {
  ...
  return Lt.getPositions = function(n) {
    const o = r(n);
    return [
      // top-left
      [0, 0],
  ...
  return Pi || (Pi = 1, function(r) {
    ...
    r.isValid = function(o) {
      ...
      for (let p = 0; p < t; p++) {
        ...
        for (let x = 0; x < t; x++) {
          let g = o.get(p, x);
          g === d ? s++ : (s >= 5 && (a += e.N1 + (s - 5)), d = g, s = 1), g = o.get(x, p), g === h ? l++ : (l >= 5 && (a += e.N1 + (l - 5)), h = g, l = 1);
        }
...
var jt = {}, Dt = {}, zt = {}, ki;
function un() {
  return ki || (ki = 1, zt.isValid = function(e) {
...
function dn() {
  ...
  oe.KANJI = new RegExp(i, "g"), oe.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g"), oe.BYTE = new RegExp(n, "g"), oe.NUMERIC = new RegExp(r, "g"), oe.ALPHANUMERIC = new RegExp(e, "g");
  const o = new RegExp("^" + i + "$"), t = new RegExp("^" + r + "$"), a = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
function Zn() {
  return zi || (zi = 1, function(r) {
    const e = Ie(), i = cn(), n = hi(), o = We(), t = un(), a = 7973, s = e.getBCHDigit(a);
    function l(x, g, W) {
      for (let v = 1; v <= 40; v++)
        if (g <= r.getCapacity(v, W, x))
          return v;
    }
    function d(x, g) {
      return o.getCharCountIndicator(x, g) + 4;
    }
    function h(x, g) {
      let W = 0;
    ...
    function p(x, g) {
      for (let W = 1; W <= 40; W++)
        if (h(x, W) <= r.getCapacity(W, g, o.MIXED))
          return W;
    }
    r.from = function(g, W) {
      return t.isValid(g) ? parseInt(g, 10) : W;
    }, r.getCapacity = function(g, W, v) {
      if (!t.isValid(g))
        throw new Error("Invalid QR Code version");
      typeof v > "u" && (v = o.BYTE);
      const S = e.getSymbolTotalCodewords(g), b = i.getTotalCodewordsCount(g, W), w = (S - b) * 8;
    ...
    }, r.getBestVersionForData = function(g, W) {
      let v;
      const S = n.from(W, n.M);
      if (Array.isArray(g)) {
        if (g.length > 1)
          return p(g, S);
        if (g.length === 0)
...
function eo() {
  if (Ni) return Nt;
  Ni = 1;
  const r = Ie(), e = 1335, i = 21522, n = r.getBCHDigit(e);
  return Nt.getEncodedBits = function(t, a) {
    const s = t.bit << 3 | a;
    let l = s << 10;
    for (; r.getBCHDigit(l) - n >= 0; )
      l ^= e << r.getBCHDigit(l) - n;
    return (s << 10 | l) ^ i;
  }, Nt;
}
var Mt = {}, Ut, Mi;
function to() {
  ...
  return e.getBitsLength = function(n) {
    ...
    for (o = 0; o + 3 <= this.data.length; o += 3)
      t = this.data.substr(o, 3), a = parseInt(t, 10), n.put(a, 10);
    const s = this.data.length - o;
    s > 0 && (t = this.data.substr(o), a = parseInt(t, 10), n.put(a, s * 3 + 1));
  }, Ut = e, Ut;
}
var qt, Ui;
function io() {
  ...
  return Ki || (Ki = 1, function(r) {
    var e = {
      single_source_shortest_paths: function(i, n, o) {
        ...
        s.push(n, 0);
        for (var l, d, h, p, x, g, W, v, S; !s.empty(); ) {
          l = s.pop(), d = l.value, p = l.cost, x = i[d] || {};
          for (h in x)
            x.hasOwnProperty(h) && (g = x[h], W = p + g, v = a[h], S = typeof a[h] > "u", (S || v > W) && (a[h] = W, s.push(h, W), t[h] = d));
        }
...
function so() {
  return Hi || (Hi = 1, function(r) {
    const e = We(), i = to(), n = io(), o = oo(), t = ro(), a = dn(), s = Ie(), l = ao();
    function d(b) {
    ...
    function p(b) {
      const w = h(a.NUMERIC, e.NUMERIC, b), m = h(a.ALPHANUMERIC, e.ALPHANUMERIC, b);
      let f, D;
      return s.isKanjiModeEnabled() ? (f = h(a.BYTE, e.BYTE, b), D = h(a.KANJI, e.KANJI, b)) : (f = h(a.BYTE_KANJI, e.BYTE, b), D = []), w.concat(m, f, D).sort(function(T, E) {
    ...
    function g(b) {
      return b.reduce(function(w, m) {
        const f = w.length - 1 >= 0 ? w[w.length - 1] : null;
        return f && f.mode === m.mode ? (w[w.length - 1].data += m.data, w) : (w.push(m), w);
      }, []);
    }
    function W(b) {
      const w = [];
    ...
    function v(b, w) {
      ...
      for (let C = 0; C < b.length; C++) {
        ...
        for (let y = 0; y < T.length; y++) {
          const L = T[y], $ = "" + C + y;
          E.push($), m[$] = { node: L, lastCount: 0 }, f[$] = {};
          for (let P = 0; P < D.length; P++) {
            const R = D[P];
            m[R] && m[R].node.mode === L.mode ? (f[R][$] = x(m[R].lastCount + L.length, L.mode) - x(m[R].lastCount, L.mode), m[R].lastCount += L.length) : (m[R] && (m[R].lastCount = L.length), f[R][$] = x(L.length, L.mode) + 4 + e.getCharCountIndicator(L.mode, w));
          }
        }
        D = E;
      }
    ...
    function S(b, w) {
      ...
      if (m = e.from(w, f), m !== e.BYTE && m.bit < f.bit)
        throw new Error('"' + b + '" cannot be encoded with mode ' + e.toString(m) + `.
 Suggested mode is: ` + e.toString(f));
      switch (m === e.KANJI && !s.isKanjiModeEnabled() && (m = e.BYTE), m) {
        case e.NUMERIC:
          return new i(b);
        case e.ALPHANUMERIC:
          return new n(b);
    ...
    r.fromArray = function(w) {
      return w.reduce(function(m, f) {
        return typeof f == "string" ? m.push(S(f, null)) : f.data && m.push(S(f.data, f.mode)), m;
      }, []);
    }, r.fromString = function(w, m) {
      const f = p(w, s.isKanjiModeEnabled()), D = W(f), C = v(D, m), T = l.find_path(C.map, "start", "end"), E = [];
      for (let y = 1; y < T.length - 1; y++)
        E.push(C.table[T[y]].node);
      return r.fromArray(g(E));
    }, r.rawSplit = function(w) {
      return r.fromArray(
        p(w, s.isKanjiModeEnabled())
      );
    };
  }(Mt)), Mt;
}
...
function lo() {
  if (Gi) return Wt;
  Gi = 1;
  const r = Ie(), e = hi(), i = Vn(), n = Kn(), o = Hn(), t = Gn(), a = Yn(), s = cn(), l = Xn(), d = Zn(), h = eo(), p = We(), x = so();
  function g(C, T) {
    ...
    for (let L = 0; L < y.length; L++) {
      ...
      for (let R = -1; R <= 7; R++)
        if (!($ + R <= -1 || E <= $ + R))
          for (let A = -1; A <= 7; A++)
            P + A <= -1 || E <= P + A || (R >= 0 && R <= 6 && (A === 0 || A === 6) || A >= 0 && A <= 6 && (R === 0 || R === 6) || R >= 2 && R <= 4 && A >= 2 && A <= 4 ? C.set($ + R, P + A, !0, !0) : C.set($ + R, P + A, !1, !0));
    }
  }
  function W(C) {
    const T = C.size;
  ...
  function v(C, T) {
    ...
    for (let y = 0; y < E.length; y++) {
      ...
      for (let P = -2; P <= 2; P++)
        for (let R = -2; R <= 2; R++)
          P === -2 || P === 2 || R === -2 || R === 2 || P === 0 && R === 0 ? C.set(L + P, $ + R, !0, !0) : C.set(L + P, $ + R, !1, !0);
    }
  }
  function S(C, T) {
    ...
    let L, $, P;
    for (let R = 0; R < 18; R++)
      L = Math.floor(R / 3), $ = R % 3 + E - 8 - 3, P = (y >> R & 1) === 1, C.set(L, $, P, !0), C.set($, L, P, !0);
  }
  function b(C, T, E) {
    const y = C.size, L = h.getEncodedBits(T, E);
    let $, P;
    for ($ = 0; $ < 15; $++)
      P = (L >> $ & 1) === 1, $ < 6 ? C.set($, 8, P, !0) : $ < 8 ? C.set($ + 1, 8, P, !0) : C.set(y - 15 + $, 8, P, !0), $ < 8 ? C.set(8, y - $ - 1, P, !0) : $ < 9 ? C.set(8, 15 - $ - 1 + 1, P, !0) : C.set(8, 15 - $ - 1, P, !0);
    C.set(y - 8, 8, 1, !0);
  }
  function w(C, T) {
    const E = C.size;
      ...
      for (R === 6 && R--; ; ) {
        for (let A = 0; A < 2; A++)
          if (!C.isReserved(L, R - A)) {
            let we = !1;
            P < T.length && (we = (T[P] >>> $ & 1) === 1), C.set(L, R - A, we), $--, $ === -1 && (P++, $ = 7);
          }
        if (L += y, L < 0 || E <= L) {
          L -= y, y = -y;
          break;
  ...
  function m(C, T, E) {
    ...
    E.forEach(function(A) {
      y.put(A.mode.bit, 4), y.put(A.getLength(), p.getCharCountIndicator(A.mode, C)), A.write(y);
    });
    const L = r.getSymbolTotalCodewords(C), $ = s.getTotalCodewordsCount(C, T), P = (L - $) * 8;
    for (y.getLengthInBits() + 4 <= P && y.put(0, 4); y.getLengthInBits() % 8 !== 0; )
      y.putBit(0);
    const R = (P - y.getLengthInBits()) / 8;
    for (let A = 0; A < R; A++)
      y.put(A % 2 ? 17 : 236, 8);
    return f(y, C, T);
  }
  function f(C, T, E) {
    const y = r.getSymbolTotalCodewords(T), L = s.getTotalCodewordsCount(T, E), $ = y - L, P = s.getBlocksCount(T, E), R = y % P, A = P - R, we = Math.floor(y / P), De = Math.floor($ / P), vn = De + 1, wi = we - De, yn = new l(wi);
    let Ct = 0;
    const Je = new Array(P), bi = new Array(P);
    let $t = 0;
    const xn = new Uint8Array(C.buffer);
    for (let Se = 0; Se < P; Se++) {
      const _t = Se < A ? De : vn;
      Je[Se] = xn.slice(Ct, Ct + _t), bi[Se] = yn.encode(Je[Se]), Ct += _t, $t = Math.max($t, _t);
    }
    const Rt = new Uint8Array(y);
    let mi = 0, ce, ue;
    for (ce = 0; ce < $t; ce++)
      for (ue = 0; ue < P; ue++)
        ce < Je[ue].length && (Rt[mi++] = Je[ue][ce]);
    for (ce = 0; ce < wi; ce++)
      for (ue = 0; ue < P; ue++)
        Rt[mi++] = bi[ue][ce];
    return Rt;
...
`
    ...
    const P = m(T, E, L), R = r.getSymbolSize(T), A = new n(R);
    return g(A, T), W(A), v(A, T), b(A, E, 0), T >= 7 && S(A, T), w(A, P), isNaN(y) && (y = a.getBestMask(
      A,
      b.bind(null, A, E)
    )), a.applyMask(y, A), b(A, E, y), {
      modules: A,
      version: T,
...
function hn() {
  return Yi || (Yi = 1, function(r) {
    ...
    r.getOptions = function(n) {
      ...
      const a = o.modules.size, s = o.modules.data, l = r.getScale(a, t), d = Math.floor((a + t.margin * 2) * l), h = t.margin * l, p = [t.color.light, t.color.dark];
      for (let x = 0; x < d; x++)
        for (let g = 0; g < d; g++) {
          let W = (x * d + g) * 4, v = t.color.light;
          if (x >= h && g >= h && x < d - h && g < d - h) {
            const S = Math.floor((x - h) / l), b = Math.floor((g - h) / l);
            v = p[s[S * a + b] ? 1 : 0];
          }
          n[W++] = v.r, n[W++] = v.g, n[W++] = v.b, n[W] = v.a;
        }
    };
  }(Yt)), Yt;
}
...
function co() {
  return Ji || (Ji = 1, function(r) {
    ...
    r.render = function(t, a, s) {
      let l = s, d = a;
      typeof l > "u" && (!a || !a.getContext) && (l = a, a = void 0), a || (d = n()), l = e.getOptions(l);
      const h = e.getImageWidth(t.modules.size, l), p = d.getContext("2d"), x = p.createImageData(h, h);
      return e.qrToImageData(x.data, t, l), i(p, d, h), p.putImageData(x, 0, 0), d;
    }, r.renderToDataURL = function(t, a, s) {
      let l = s;
      typeof l > "u" && (!a || !a.getContext) && (l = a, a = void 0), l || (l = {});
      const d = r.render(t, a, l), h = l.type || "image/png", p = l.rendererOpts || {};
      return d.toDataURL(h, p.quality);
    };
  }(Gt)), Gt;
}
var Jt = {}, Qi;
function uo() {
  ...
  function n(o, t, a) {
    ...
    for (let p = 0; p < o.length; p++) {
      const x = Math.floor(p % t), g = Math.floor(p / t);
      !x && !d && (d = !0), o[p] ? (h++, p > 0 && x > 0 && o[p - 1] || (s += d ? i("M", x + a, 0.5 + g + a) : i("m", l, 0), l = 0, d = !1), x + 1 < t && o[p + 1] || (s += i("h", h), h = 0)) : l++;
    }
    return s;
  }
  return Jt.render = function(t, a, s) {
    const l = r.getOptions(a), d = t.modules.size, h = t.modules.data, p = d + l.margin * 2, x = l.color.light.a ? "<path " + e(l.color.light, "fill") + ' d="M0 0h' + p + "v" + p + 'H0z"/>' : "", g = "<path " + e(l.color.dark, "stroke") + ' d="' + n(h, d, l.margin) + '"/>', W = 'viewBox="0 0 ' + p + " " + p + '"', S = '<svg xmlns="http://www.w3.org/2000/svg" ' + (l.width ? 'width="' + l.width + '" height="' + l.width + '" ' : "") + W + ' shape-rendering="crispEdges">' + x + g + `</svg>
`;
...
function ho() {
  if (Xi) return Te;
  Xi = 1;
  const r = Fn(), e = lo(), i = co(), n = uo();
  function o(t, a, s, l, d) {
    const h = [].slice.call(arguments, 1), p = h.length, x = typeof h[p - 1] == "function";
    if (!x && !r())
      throw new Error("Callback required as last argument");
    if (x) {
      if (p < 2)
        throw new Error("Too few arguments provided");
      p === 2 ? (d = s, s = a, a = l = void 0) : p === 3 && (a.getContext && typeof d > "u" ? (d = l, l = void 0) : (d = l, l = s, s = a, a = void 0));
    } else {
      if (p < 1)
        throw new Error("Too few arguments provided");
      return p === 1 ? (s = a, a = l = void 0) : p === 2 && !a.getContext && (l = s, s = a, a = void 0), new Promise(function(g, W) {
        try {
    ...
    try {
      const g = e.create(s, l);
      d(null, t(g, a, l));
    } catch (g) {
      d(g);
    }
  }
  return Te.create = e.create, Te.toCanvas = o.bind(null, i.render), Te.toDataURL = o.bind(null, i.renderToDataURL), Te.toString = o.bind(null, function(t, a, s) {
    return n.render(t, s);
  }), Te;
}
var fo = ho();
const po = /* @__PURE__ */ In(fo), go = 0.1, Zi = 2.5, de = 7;
function Qt(r, e, i) {
  return r === e ? !1 : (r - e < 0 ? e - r : r - e) <= i + go;
}
function wo(r, e) {
  const i = Array.prototype.slice.call(po.create(r, { errorCorrectionLevel: e }).modules.data, 0), n = Math.sqrt(i.length);
...
const bo = {
  generate({ uri: r, size: e, logoSize: i, dotColor: n = "#141414" }) {
    ...
    d.forEach(({ x: v, y: S }) => {
      const b = (s.length - de) * l * v, w = (s.length - de) * l * S, m = 0.45;
    ...
    const h = Math.floor((i + 25) / l), p = s.length / 2 - h / 2, x = s.length / 2 + h / 2 - 1, g = [];
    s.forEach((v, S) => {
      v.forEach((b, w) => {
        if (s[S][w] && !(S < de && w < de || S > s.length - (de + 1) && w < de || S < de && w > s.length - (de + 1)) && !(S > p && S < x && w > p && w < x)) {
          const m = S * l + l / 2, f = w * l + l / 2;
          g.push([m, f]);
        }
      });
    });
    const W = {};
    return g.forEach(([v, S]) => {
      var b;
      W[v] ? (b = W[v]) == null || b.push(S) : W[v] = [S];
    }), Object.entries(W).map(([v, S]) => {
      const b = S.filter((w) => S.every((m) => !Qt(w, m, l)));
      return [Number(v), b];
    }).forEach(([v, S]) => {
      S.forEach((b) => {
        a.push(Ne`<circle cx=${v} cy=${b} fill=${n} r=${l / Zi} />`);
      });
    }), Object.entries(W).filter(([v, S]) => S.length > 1).map(([v, S]) => {
      const b = S.filter((w) => S.some((m) => Qt(w, m, l)));
      return [Number(v), b];
    }).map(([v, S]) => {
      S.sort((w, m) => w < m ? -1 : 1);
      const b = [];
      for (const w of S) {
        const m = b.find((f) => f.some((D) => Qt(w, D, l)));
        m ? m.push(w) : b.push([w]);
      }
      return [v, b.map((w) => [w[0], w[w.length - 1]])];
    }).forEach(([v, S]) => {
      S.forEach(([b, w]) => {
        a.push(Ne`
              <line
...
ge([
  u()
], ie.prototype, "uri", void 0);
ge([
  u({ type: Number })
], ie.prototype, "size", void 0);
ge([
  u()
], ie.prototype, "theme", void 0);
ge([
  u()
], ie.prototype, "imageSrc", void 0);
ge([
  u()
], ie.prototype, "alt", void 0);
ge([
  u()
], ie.prototype, "color", void 0);
ge([
  u({ type: Boolean })
], ie.prototype, "arenaClear", void 0);
ge([
  u({ type: Boolean })
], ie.prototype, "farcaster", void 0);
ie = ge([
  B("wui-qr-code")
], ie);
const yo = N`
...
let ii = class extends V {
  ...
  qrCodeTemplate() {
    ...
    return j.setWcLinking(void 0), j.setRecentWallet(this.wallet), c` <wui-qr-code
      size=${e}
...
ii.styles = Ro;
ii = _o([
  B("w3m-connecting-wc-qrcode")
], ii);
var Eo = function(r, e, i, n) {
  var o = arguments.length, t = o < 3 ? e : n === null ? n = Object.getOwnPropertyDescriptor(e, i) : n, a;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(r, e, i, n);
  else for (var s = r.length - 1; s >= 0; s--) (a = r[s]) && (t = (o < 3 ? a(t) : o > 3 ? a(e, i, t) : a(e, i)) || t);
  return o > 3 && t && Object.defineProperty(e, i, t), t;
...
let en = class extends O {
  constructor() {
    var e;
    if (super(), this.wallet = (e = U.state.data) == null ? void 0 : e.wallet, !this.wallet)
...
en = Eo([
  B("w3m-connecting-wc-unsupported")
], en);
var fn = function(r, e, i, n) {
  var o = arguments.length, t = o < 3 ? e : n === null ? n = Object.getOwnPropertyDescriptor(e, i) : n, a;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(r, e, i, n);
  else for (var s = r.length - 1; s >= 0; s--) (a = r[s]) && (t = (o < 3 ? a(t) : o > 3 ? a(e, i, t) : a(e, i)) || t);
  return o > 3 && t && Object.defineProperty(e, i, t), t;
...
let ni = class extends V {
  constructor() {
    ...
    this.onConnect = this.onConnectProxy.bind(this), this.secondaryBtnLabel = "Open", this.secondaryLabel = rn.CONNECT_LABELS.MOBILE, this.secondaryBtnIcon = "externalLink", this.updateLoadingState(), this.unsubscribe.push(j.subscribeKey("wcUri", () => {
  ...
  onConnectProxy() {
    ...
    if ((e = this.wallet) != null && e.webapp_link && this.uri)
      try {
        this.error = !1;
        const { webapp_link: i, name: n } = this.wallet, { redirect: o, href: t } = k.formatUniversalUrl(i, this.uri);
        j.setWcLinking({ name: n, href: t }), j.setRecentWallet(this.wallet), k.openHref(o, "_blank");
      } catch {
        this.error = !0;
      }
...
fn([
  _()
], ni.prototype, "isLoading", void 0);
ni = fn([
  B("w3m-connecting-wc-web")
], ni);
var Ge = function(r, e, i, n) {
  var o = arguments.length, t = o < 3 ? e : n === null ? n = Object.getOwnPropertyDescriptor(e, i) : n, a;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(r, e, i, n);
...
let Le = class extends O {
  constructor() {
    var e;
    super(), this.wallet = (e = U.state.data) == null ? void 0 : e.wallet, this.unsubscribe = [], this.platform = void 0, this.platforms = [], this.isSiwxEnabled = !!ee.state.siwx, this.remoteFeatures = ee.state.remoteFeatures, this.determinePlatforms(), this.initializeConnection(), this.unsubscribe.push(ee.subscribeKey("remoteFeatures", (i) => this.remoteFeatures = i));
  }
  disconnectedCallback() {
    this.unsubscribe.forEach((e) => e());
  }
  ...
  reownBrandingTemplate() {
    var e;
    return (e = this.remoteFeatures) != null && e.reownBranding ? c`<wui-ux-by-reown></wui-ux-by-reown>` : null;
  }
  async initializeConnection(e = !1) {
    if (!(this.platform === "browser" || ee.state.manualWCControl && !e))
      try {
        const { wcPairingExpiry: i, status: n } = j.state;
        (e || ee.state.enableEmbedded || k.isPairingExpired(i) || n === "connecting") && (await j.connectWalletConnect(), this.isSiwxEnabled || on.close());
      } catch (i) {
        te.sendEvent({
          type: "track",
          event: "CONNECT_ERROR",
          properties: { message: (i == null ? void 0 : i.message) ?? "Unknown" }
        }), j.setWcError(!0), Xe.showError(i.message ?? "Connection error"), j.resetWcConnection(), U.goBack();
      }
  }
  determinePlatforms() {
    if (!this.wallet) {
    ...
    if (this.platform)
      return;
    const { mobile_link: e, desktop_link: i, webapp_link: n, injected: o, rdns: t } = this.wallet, a = o == null ? void 0 : o.map(({ injected_id: W }) => W).filter(Boolean), s = [...t ? [t] : a ?? []], l = ee.state.isUniversalProvider ? !1 : s.length, d = e, h = n, p = j.checkInstalled(s), x = l && p, g = i && !k.isMobile();
    x && !Zt.state.noAdapters && this.platforms.push("browser"), d && this.platforms.push(k.isMobile() ? "mobile" : "qrcode"), h && this.platforms.push("web"), g && this.platforms.push("desktop"), !x && l && !Zt.state.noAdapters && this.platforms.push("unsupported"), this.platform = this.platforms[0];
  }
  platformTemplate() {
...
let oi = class extends O {
  constructor() {
    super(...arguments), this.isMobile = k.isMobile();
  }
  render() {
    if (this.isMobile) {
      const { featured: e, recommended: i } = z.state, { customWallets: n } = ee.state, o = ft.getRecentWallets(), t = e.length || i.length || (n == null ? void 0 : n.length) || o.length;
      return c`<wui-flex
        flexDirection="column"
        gap="xs"
        .margin=${["3xs", "s", "s", "s"]}
...
pn([
  _()
], oi.prototype, "isMobile", void 0);
oi = pn([
  B("w3m-connecting-wc-basic-view")
], oi);
/**
 * @license
...
const Xt = /* @__PURE__ */ new WeakMap(), pi = Rn(class extends _n {
  render(r) {
    return yi;
  }
  update(r, [e]) {
    var n;
    const i = e !== this.G;
    return i && this.G !== void 0 && this.rt(void 0), (i || this.lt !== this.ct) && (this.G = e, this.ht = (n = r.options) == null ? void 0 : n.host, this.rt(this.ct = r.element)), yi;
  }
  rt(r) {
    if (this.isConnected || (r = void 0), typeof this.G == "function") {
      const e = this.ht ?? globalThis;
      let i = Xt.get(e);
      i === void 0 && (i = /* @__PURE__ */ new WeakMap(), Xt.set(e, i)), i.get(this.G) !== void 0 && this.G.call(this.ht, void 0), i.set(this.G, r), r !== void 0 && this.G.call(this.ht, r);
    } else this.G.value = r;
  }
  get lt() {
    var r, e;
    return typeof this.G == "function" ? (r = Xt.get(this.ht ?? globalThis)) == null ? void 0 : r.get(this.G) : (e = this.G) == null ? void 0 : e.value;
  }
  disconnected() {
...
let lt = class extends O {
  constructor() {
    super(...arguments), this.inputElementRef = fi(), this.checked = void 0;
  }
  render() {
    return c`
      <label>
...
let X = class extends O {
  constructor() {
    super(...arguments), this.inputElementRef = fi(), this.size = "md", this.disabled = !1, this.placeholder = "", this.type = "text", this.value = "";
  }
  render() {
...
let ri = class extends O {
  constructor() {
    super(...arguments), this.inputComponentRef = fi();
  }
  render() {
    return c`
      <wui-input-text
...
`;
var je = function(r, e, i, n) {
  var o = arguments.length, t = o < 3 ? e : n === null ? n = Object.getOwnPropertyDescriptor(e, i) : n, a;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(r, e, i, n);
  else for (var s = r.length - 1; s >= 0; s--) (a = r[s]) && (t = (o < 3 ? a(t) : o > 3 ? a(e, i, t) : a(e, i)) || t);
  return o > 3 && t && Object.defineProperty(e, i, t), t;
};
const tn = "local-paginator";
let me = class extends O {
  ...
  walletsTemplate() {
    var n;
    const e = ((n = this.filteredWallets) == null ? void 0 : n.length) > 0 ? k.uniqueBy([...this.featured, ...this.recommended, ...this.filteredWallets], "id") : k.uniqueBy([...this.featured, ...this.recommended, ...this.wallets], "id");
    return pt.markWalletsAsInstalled(e).map((o) => c`
  ...
  paginationLoaderTemplate() {
    const { wallets: e, recommended: i, featured: n, count: o } = z.state, t = window.innerWidth < 352 ? 3 : 4, a = e.length + i.length;
    let l = Math.ceil(a / t) * t - a + t;
    return l -= e.length ? n.length % t : 0, o === 0 && n.length > 0 ? null : o === 0 || [...n, ...e, ...i].length < o ? this.shimmerTemplate(l, tn) : null;
  }
  createPaginationObserver() {
    var i;
    const e = (i = this.shadowRoot) == null ? void 0 : i.querySelector(`#${tn}`);
    e && (this.paginationObserver = new IntersectionObserver(([n]) => {
      if (n != null && n.isIntersecting && !this.loading) {
        const { page: o, count: t, wallets: a } = z.state;
        a.length < t && z.fetchWalletsByPage({ page: o + 1 });
      }
...
je([
  _()
], me.prototype, "wallets", void 0);
je([
  _()
], me.prototype, "recommended", void 0);
je([
  _()
], me.prototype, "featured", void 0);
je([
  _()
], me.prototype, "filteredWallets", void 0);
me = je([
  B("w3m-all-wallets-list")
], me);
const zo = N`
  wui-grid,
  wui-loading-spinner,
...
let Oe = class extends O {
  ...
  walletsTemplate() {
    const { search: e } = z.state, i = pt.markWalletsAsInstalled(e);
    return e.length ? c`
      <wui-grid
...
let ht = class extends O {
  constructor() {
    super(...arguments), this.search = "", this.onDebouncedSearch = k.debounce((e) => {
      this.search = e;
    });
  }
  render() {
...
let nn = class extends O {
  constructor() {
    var e;
    super(...arguments), this.wallet = (e = U.state.data) == null ? void 0 : e.wallet;
  }
  render() {
    if (!this.wallet)
  ...
  chromeTemplate() {
    var e;
    return (e = this.wallet) != null && e.chrome_store ? c`<wui-list-item
      variant="icon"
      icon="chromeStore"
      iconVariant="square"
  ...
  iosTemplate() {
    var e;
    return (e = this.wallet) != null && e.app_store ? c`<wui-list-item
      variant="icon"
      icon="appStore"
      iconVariant="square"
      @click=${this.onAppStore.bind(this)}
  ...
  androidTemplate() {
    var e;
    return (e = this.wallet) != null && e.play_store ? c`<wui-list-item
      variant="icon"
      icon="playStore"
      iconVariant="square"
      @click=${this.onPlayStore.bind(this)}
  ...
  homepageTemplate() {
    var e;
    return (e = this.wallet) != null && e.homepage ? c`
      <wui-list-item
        variant="icon"
        icon="browser"
  ...
  onChromeStore() {
    var e;
    (e = this.wallet) != null && e.chrome_store && k.openHref(this.wallet.chrome_store, "_blank");
  }
  onAppStore() {
    var e;
    (e = this.wallet) != null && e.app_store && k.openHref(this.wallet.app_store, "_blank");
